...
const ImageInput: FC<ImageInputProps> = ({ id, cropImg, aspect, iconOnly }) => {
  // states
  ...
  return (
    <>
      ...
      {!iconOnly ? (
        <div
          className="bg-lit-light-gray w-full rounded-md relative"
          style={{ maxWidth: 700 }}
        ...
        >
          <div style={{ paddingTop: `${(1 / aspect) * 100}%` }}>
            <div className="absolute inset-0">
              <div className="w-full h-full p-10 relative flex flex-col items-center justify-center">
                <label
                  htmlFor={id}
                ...
                <div className="mt-5 font-Poppins text-sm text-center">
                  Drag and drop or{" "}
        ...
        <label
          htmlFor={id}
          className="bg-white cursor-pointer rounded-full h-14 w-14 flex items-center justify-center absolute z-10 -bottom-4 -right-4"
